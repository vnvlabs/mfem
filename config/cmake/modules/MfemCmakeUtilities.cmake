...
macro(mfem_add_executable NAME)
  if (MFEM_USE_HIP)
    ...
    if (MFEM_USE_VNV)
	    string(REGEX REPLACE "\-" "\_" VNV_NAME ${NAME})
	    link_vnv_executable(${NAME} ${VNV_NAME} cpp)
      target_compile_definitions(${NAME} PRIVATE VNVPNAME=${VNV_NAME})
    endif()	      
  endif()
endmacro()
...
macro(add_mfem_examples EXE_SRCS)
  ...
  foreach(SRC_FILE IN LISTS ${EXE_SRCS})
    ...
    if(CMAKE_VERSION VERSION_GREATER 2.8.11)
	    target_link_libraries(${EXE_NAME} PRIVATE mfem)
    else()
